...
export default {
  ...
  'dashboard.no_displays_desc': 'Instala la aplicación de Camanchaca CMS en tu TV y vincúlala con el botón de arriba.',
  ...
  'device.tab.playlist_tip': 'Contenido asignado a este dispositivo. Arrastra para reordenar. Agrega medios.',
  ...
  'device.alt_current_screen': 'Pantalla actual',
  ...
  'device.assign.duration_label': 'Duración (segundos, para imágenes)',
  ...
  'settings.setup_step_1': 'Instala el APK de Camanchaca CMS en tu TV mediante sideloading',
  ...
  'settings.import.invalid_file': 'Archivo no válido. Debe ser un JSON o ZIP de exportación de Camanchaca CMS.',
  ...
  'onboarding.step.welcome.title': '¡Bienvenido a Camanchaca CMS!',
  ...
  'dashboard.create_video_wall': 'Crear muro de video',
  'dashboard.clear_selection': 'Limpiar',
  'dashboard.select_for_wall': 'Seleccionar para muro',
  'dashboard.display_selected_singular': '{n} pantalla seleccionada - selecciona 1 más para crear un muro',
  'dashboard.display_selected_plural': '{n} pantallas seleccionadas',
  'dashboard.select_at_least_2': 'Selecciona al menos 2 pantallas para crear un muro de video',
  'dashboard.storage_free': 'libres',
  'dashboard.wall_label': 'muro',
  'dashboard.tile_singular': 'panel',
  'dashboard.tile_plural': 'paneles',
  'dashboard.online_count_wall': 'en línea',
  'dashboard.video_walls_title': 'Muros de video',

  // Video wall editor
  'wall.rename_wall': 'Renombrar muro',
  'wall.center_view': 'Recentrar',
  'wall.center_view_title': 'Recentrar y ajustar contenido al viewport',
  'wall.auto_arrange_title': 'Disponer pantallas en cuadrícula usando columnas/filas/bisel de abajo',
  'wall.fit_player_title': 'Ajustar el rectángulo del reproductor al borde de todas las pantallas',
  'wall.save_layout': 'Guardar diseño',
  'wall.how_it_works': 'Cómo funciona',
  'wall.how_it_works_1': 'Cada rectángulo es una pantalla física.',
  'wall.how_it_works_2': 'El rectángulo azul punteado es la ventana del reproductor — el contenido se reproduce dentro de este rectángulo.',
  'wall.how_it_works_3': 'Cada pantalla muestra solo la parte del reproductor que se superpone a ella.',
  'wall.how_it_works_4': 'Arrastra las esquinas para redimensionar, arrastra el cuerpo para mover.',
  'wall.drag_hint': 'Arrastra al canvas para agregar. Usa la ✕ en un panel para quitar.',
  'wall.cols_rows_hint': 'Cols/filas/bisel se usan en Auto-disponer. Arrastra libremente en el canvas para anular.',
  'wall.fine_position': 'Posición fina',
  'wall.fine_position_hint': 'Haz clic en un panel o el reproductor para ajustar posiciones exactas en píxeles.',
  'wall.player_rect': 'Rectángulo del reproductor',
  'wall.screen': 'Pantalla',
  'wall.deselect': 'Deseleccionar',
  'wall.arrow_keys_hint': 'Las flechas mueven 1px. Mantén Shift para 10px.',
  'wall.click_outside_hint': 'Haz clic fuera de cualquier rectángulo para deseleccionar.',
  'wall.remove_from_wall': 'Quitar del muro',
  'wall.layout_saved': 'Diseño guardado',
  'wall.prompt_name': 'Nombre del muro:',
  'wall.playlist': 'Lista',
  'wall.no_playlist': 'Sin lista',
  'wall.set_playlist': 'Establecer lista',
  'wall.playlist_updated': 'Lista actualizada',
  'wall.confirm_delete': '¿Eliminar muro "{name}"? Esto devolverá todas las pantallas a sin grupo.',
  'wall.draft_suffix': '(borrador)',

  // Help guides
  'help.guide_display_title': 'Configurar una pantalla',
  'help.guide_display_1': 'Descarga el APK o abre el Reproductor web',
  'help.guide_display_2': 'Ingresa la URL de tu servidor',
  'help.guide_display_3': 'Anota el código de vinculación de 6 dígitos',
  'help.guide_display_4': 'Haz clic en "Agregar pantalla" en el panel e ingresa el código',
  'help.guide_display_5': 'Asigna contenido a la lista de la pantalla',

  'help.guide_upload_title': 'Subir contenido',
  'help.guide_upload_1': 'Ve a Biblioteca de contenido',
  'help.guide_upload_2': 'Arrastra y suelta archivos o haz clic en el área de subida',
  'help.guide_upload_3': 'Soporta MP4, WebM, JPEG, PNG, GIF, WebP',
  'help.guide_upload_4': 'Los videos detectan duración y generan miniaturas automáticamente',
  'help.guide_upload_5': 'Usa URL remota para transmitir desde fuentes externas',

  'help.guide_layouts_title': 'Diseños multizona',
  'help.guide_layouts_1': 'Ve a Diseños y crea uno nuevo o usa una plantilla',
  'help.guide_layouts_2': 'Arrastra zonas para posicionarlas en el canvas',
  'help.guide_layouts_3': 'Redimensiona usando el manejador de la esquina',
  'help.guide_layouts_4': 'Asigna el diseño a un dispositivo en la pestaña Lista',
  'help.guide_layouts_5': 'Cada zona puede mostrar contenido diferente',

  'help.guide_schedule_title': 'Programación de contenido',
  'help.guide_schedule_1': 'Ve a Horario y selecciona un dispositivo',
  'help.guide_schedule_2': 'Haz clic en "Agregar horario" para crear una franja horaria',
  'help.guide_schedule_3': 'Configura horas de inicio/fin y reglas de recurrencia',
  'help.guide_schedule_4': 'Los horarios de mayor prioridad anulan los de menor prioridad',
  'help.guide_schedule_5': 'El contenido cambia automáticamente según el horario',

  'help.guide_remote_title': 'Control remoto',
  'help.guide_remote_1': 'Ve a la página de detalle de un dispositivo',
  'help.guide_remote_2': 'Haz clic en la pestaña "Control remoto"',
  'help.guide_remote_3': 'Haz clic en "Iniciar control remoto" para comenzar la transmisión',
  'help.guide_remote_4': 'Usa el d-pad, volumen y botones de encendido',
  'help.guide_remote_5': 'Haz clic en cualquier parte de la pantalla para simular un toque',

  'help.guide_walls_title': 'Muros de video',
  'help.guide_walls_1': 'Ve a Muros de video y crea uno nuevo',
  'help.guide_walls_2': 'Configura el tamaño de la cuadrícula (p. ej., 2x2)',
  'help.guide_walls_3': 'Arrastra dispositivos a las posiciones de la cuadrícula',
  'help.guide_walls_4': 'Ajusta la compensación de bisel si es necesario',
  'help.guide_walls_5': 'Asigna contenido para reproducir en todas las pantallas',

  // Workspace rename modal
  'workspace.rename_title': 'Renombrar workspace',
  'workspace.name_label': 'Nombre',
  'workspace.slug_label': 'Slug',
  'workspace.slug_optional': 'opcional, seguro para URL',
  'workspace.slug_placeholder': 'p. ej. studio-a',
  'workspace.slug_hint': 'Letras minúsculas, dígitos, guiones. Debe ser único.',
  'workspace.cancel': 'Cancelar',
  'workspace.save': 'Guardar',
  'workspace.name_required': 'El nombre no puede estar vacío',
  'workspace.saving': 'Guardando...',
  'workspace.rename_failed': 'Error al renombrar',
  ...
  'api.request_failed': 'Error en la solicitud',
