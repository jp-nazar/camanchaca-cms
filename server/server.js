...
// - SELF_HOSTED=true: allow all origins (operator controls their own deployment).
  // - production:       allowlist localhost dev only.
...
// Always redirect root to the app — no marketing landing page
app.get('/', (req, res) => {
...
// Subscription endpoint removed — all features unlimited in self-hosted mode
...
// silently never fired). Auth routes are already
